...
const InitPassword: React.FC = () => {
  ...
  const handleInitPassword = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault()
    ...
    <div className="flex items-center justify-center h-screen bg-background">
      <div className="flex h-[80%] w-[80%] rounded-lg shadow-lg overflow-hidden bg-white">
        <div
          ...
          style={{ backgroundImage: "url('/assets/img/auth/initiatePassword.jpg')" }}
        >
          {/* Overlay */}
        ...
        <div className="flex flex-col justify-center w-full md:w-2/5 p-8">
          <form onSubmit={handleInitPassword} className="flex flex-col gap-6 text-center">
            ...
            <h2 className="text-3xl font-semibold text-primary">INITIATE PASSWORD</h2>

            <div className="flex items-center border-b rounded-l-lg border-gray-300">
              <div className="w-9 h-9 bg-primary grid place-content-center rounded-lg">
